...
void ReadAllValues() {
  ...
  ssid = preferences.getString("ssid", "Sahasra");
  password = preferences.getString("password", "wintek@143");
...
//         if (jsonMode) jsonReply("update_firmware", "ok", "ota no updates");
//         break;
//       case HTTP_UPDATE_OK:
...
void jsonSend_IRDA1_RAW(String rawData) {
  ...
  doc["status"] = "ok";
  doc["cmd"] = "IRDA1";
  doc["msg"] = "irda 1ph raw ok";
  JsonObject data = doc.createNestedObject("data");
  data["raw"] = rawData;
  data["battery_pct"] = readBattPct();
...
void jsonSend_IRDA3SR_RAW(String importRaw, String exportRaw) {
  ...
  doc["status"] = "ok";
  doc["cmd"] = "IRDA3SR";
  doc["msg"] = "irda 3ph solar raw ok";
  JsonObject data = doc.createNestedObject("data");
  data["import_raw"] = importRaw;
  data["export_raw"] = exportRaw;
  data["battery_pct"] = readBattPct();
  data["version"] = FW_VERSION;
  jsonReplyWithDoc(doc);
}
...
void jsonSend_IRDA3P_PARSED(const char* cmdName) {
  ...
  doc["status"] = "ok";
  doc["cmd"] = cmdName;
  doc["msg"] = "irda 3ph parsed ok";
  JsonObject data = doc.createNestedObject("data");

  message4[0] = 0;
  message4[1] = readString[20];
  message4[2] = readString[19];
  message4[3] = readString[18];
  str_hexto_dec();
  data["mfid"] = y;
  ...
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[28];
  message4[3] = readString[27];
  str_hexto_dec();
  data["voltage_r"] = (float)y / 10.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[30];
  message4[3] = readString[29];
  str_hexto_dec();
  data["voltage_y"] = (float)y / 10.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[32];
  message4[3] = readString[31];
  str_hexto_dec();
  data["voltage_b"] = (float)y / 10.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[34];
  message4[3] = readString[33];
  str_hexto_dec();
  data["current_r"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[36];
  message4[3] = readString[35];
  str_hexto_dec();
  data["current_y"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[38];
  message4[3] = readString[37];
  str_hexto_dec();
  data["current_b"] = (float)y / 100.0;

  message4[0] = readString[46];
  message4[1] = readString[45];
  message4[2] = readString[44];
  message4[3] = readString[43];
  str_hexto_dec();
  data["kwh"] = (float)y / 100.0;
  message4[0] = readString[58];
  message4[1] = readString[57];
  message4[2] = readString[56];
  message4[3] = readString[55];
  str_hexto_dec();
  data["kvah"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[60];
  message4[3] = readString[59];
  str_hexto_dec();
  data["lbp1kvamd"] = (float)y / 100.0;
  ...
  String makeStr = "";
  makeStr += (char)readString[66];
  makeStr += (char)readString[67];
  makeStr += (char)readString[68];
  data["make"] = makeStr;
  data["phase"] = (int)readString[69];
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[71];
  message4[3] = readString[70];
  str_hexto_dec();
  data["mul_factor"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[89];
  message4[3] = readString[88];
  str_hexto_dec();
  data["md_reset_count"] = y;
...
void jsonSend_IRDA3P_PARSED_HPL(const char* cmdName) {
  ...
  String mfidStr = "";
  mfidStr += (char)readString[30];
  mfidStr += (char)readString[29];
  a = readString[28];
  bcd_char();
  mfidStr += String(a2);
  mfidStr += String(a1);
  ...
  mfidStr += String(a2);
  mfidStr += String(a1);
  message4[0] = readString[26];
  message4[1] = readString[25];
  message4[2] = readString[24];
  message4[3] = readString[23];
  str_hexto_dec();
  int digits = 0;
  yb = y;
  while (yb > 0) {
  ...
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[40];
  message4[3] = readString[39];
  str_hexto_dec();
  data["voltage_y"] = (float)y / 10.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[42];
  message4[3] = readString[41];
  str_hexto_dec();
  data["voltage_b"] = (float)y / 10.0;
  message4[0] = 0;
  message4[1] = 0;
  ...
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[46];
  message4[3] = readString[45];
  str_hexto_dec();
  data["current_y"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[48];
  message4[3] = readString[47];
  str_hexto_dec();
  data["current_b"] = (float)y / 100.0;

  message4[0] = readString[52];
  message4[1] = readString[51];
  message4[2] = readString[50];
  message4[3] = readString[49];
  str_hexto_dec();
  data["kwh"] = (float)y / 100.0;
  message4[0] = readString[56];
  message4[1] = readString[55];
  message4[2] = readString[54];
  message4[3] = readString[53];
  str_hexto_dec();
  data["kvah"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[58];
  message4[3] = readString[57];
  str_hexto_dec();
  data["lbp1kvamd"] = (float)y / 100.0;
  ...
  String makeStr = "";
  makeStr += (char)readString[64];
  makeStr += (char)readString[65];
  makeStr += (char)readString[66];
  data["make"] = makeStr;
  data["phase"] = (int)readString[67];
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[69];
  message4[3] = readString[68];
  str_hexto_dec();
  data["mul_factor"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
...
void jsonSend_IRIR3_PARSED() {
  ...
  doc["status"] = "ok";
  doc["cmd"] = "IRIR3P";
  doc["msg"] = "ir 3ph parsed ok";
  JsonObject data = doc.createNestedObject("data");

  message4[0] = readString[6];
  message4[1] = readString[7];
  message4[2] = readString[8];
  message4[3] = readString[9];
  str_hexto_dec();
  data["mfid"] = y;
  ...
  message4[0] = readString[15];
  message4[1] = readString[16];
  message4[2] = readString[17];
  message4[3] = readString[18];
  str_hexto_dec();
  data["kwh"] = (float)y / 1000.0;
  message4[0] = readString[19];
  message4[1] = readString[20];
  message4[2] = readString[21];
  message4[3] = readString[22];
  str_hexto_dec();
  data["kvarh_lag"] = (float)y / 1000.0;
  message4[0] = readString[23];
  message4[1] = readString[24];
  message4[2] = readString[25];
  message4[3] = readString[26];
  str_hexto_dec();
  data["kvarh_lead"] = (float)y / 1000.0;
  message4[0] = readString[27];
  message4[1] = readString[28];
  message4[2] = readString[29];
  message4[3] = readString[30];
  str_hexto_dec();
  data["kvah"] = (float)y / 1000.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = 0;
  message4[3] = readString[31];
  str_hexto_dec();
  data["avg_pf"] = (float)y / 100.0;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[32];
  message4[3] = readString[33];
  str_hexto_dec();
  data["md_kwh"] = (float)y / 1000.0;
  ...
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[39];
  message4[3] = readString[40];
  str_hexto_dec();
  data["tamper_count"] = y;
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[41];
  message4[3] = readString[42];
  str_hexto_dec();
  data["tamper_status"] = y;
...
void processCommand() {
  ...
  if (readString.charAt(0) == '{') {
    ...
    if (err) {
      jsonReply("parse_error", "error", "invalid json");
      return;
    }
    ...
    if (cmd == "set_key") {
      ledon();
      beep1();
      update_apikey(paramVal);
      ledoff();
      return;
    }
    if (cmd == "get_key_status") {
      ledon();
      beep1();
      get_key_status();
      ledoff();
    ...
    if (cmd == "update_password") {
      ledon();
      beep1();
      update_password(paramVal);
      ledoff();
      return;
    }
    if (cmd == "update_ipaddress") {
      ledon();
      beep1();
      update_ipaddress(paramVal);
      ledoff();
      return;
    }
    if (cmd == "update_port") {
  ...
  if (readString.indexOf("update_bname") != -1) {
    ledon();
    beep1();
    update_bname();
    ledoff();
  }
  if (readString.indexOf("update_ssid") != -1) {
    ledon();
    beep1();
    update_ssid();
    ledoff();
  }
  if (readString.indexOf("update_password") != -1) {
    ledon();
    beep1();
    update_password();
    ledoff();
  }
  if (readString.indexOf("update_ipaddress") != -1) {
    ledon();
    beep1();
    update_ipaddress();
    ledoff();
  }
  if (readString.indexOf("update_port") != -1) {
    ledon();
    beep1();
    update_port();
    ledoff();
  }
  if (readString.indexOf("update_firmware") != -1) {
    ledon();
    beep1();
    checkForFirmwareUpdate();
    ledoff();
  }
  if (readString.indexOf("get_config") != -1) {
    ledon();
    beep1();
    ReadAllValues();
    ledoff();
  ...
  if (readString == "#BATTV*") {
    ...
    batt_val = 0;
    for (i = 0; i < 51; i++) {
      batt_val += analogRead(15);
      delay(20);
    }
    batt_val = batt_val / 50;
...
void IRDA1_PHASE() {
  readString = "";
  SerialPort2.println(":00413BC4");
  delay(200);
  PACKET_READ();
  SerialPort2.println(":00423AC5");
  delay(200);
  PACKET_READ();
  SerialPort2.println(":004339C6");
  delay(200);
  PACKET_READ();
  SerialPort2.println(":004537C8");
  delay(200);
  PACKET_READ();
  SerialPort2.println(":004636C9");
  delay(200);
  PACKET_READ();

  if (jsonMode) {
    jsonSend_IRDA1_RAW(readString);
  } else {
    SerialBT.println(readString);
    BATT_STATUS();
    SerialBT.println("DATA RECEIVED: IRDA-1Ph-RAW.");
    SerialBT.print((char)254);
    delay(10);
  }
}
...
void IRDA1_PHASE_P() {
  ...
  readString = "";
  PACKET_READ();
  String l_sno = readString;
  l_sno.remove(0, 16);
  l_sno.remove(l_sno.length() - 6, 6);
  l_sno.trim();
  ...
  readString = "";
  PACKET_READ();
  String l_mfid = readString;
  l_mfid.remove(0, 16);
  l_mfid.remove(l_mfid.length() - 6, 6);
  l_mfid.trim();
  ...
  readString = "";
  PACKET_READ();
  String l_kwh = readString;
  l_kwh.remove(0, 16);
  l_kwh.remove(l_kwh.length() - 6, 6);
  l_kwh.trim();
  ...
  readString = "";
  PACKET_READ();
  String l_rmd = readString;
  l_rmd.remove(0, 16);
  l_rmd.remove(5);
  l_rmd.trim();

  if (jsonMode) {
    jsonSend_IRDA1_PARSED(l_sno, l_mfid, l_kwh, l_rmd);
  } else {
    SerialBT.println("S.NO:" + l_sno);
    SerialBT.println("M.ID:" + l_mfid);
    SerialBT.println("KWH:" + l_kwh);
    SerialBT.println("RMD:" + l_rmd);
    BATT_STATUS();
...
void IRDA3_PHASE() {
  ...
  if (meter_flag == 5) {
    ...
    if (jsonMode) jsonSend_IRDA3SR_RAW(importRaw, exportRaw);
      ...
      SerialBT.println(importRaw);
      SerialBT.println("                 ");
      SerialBT.println("** EXPORT DATA **");
      SerialBT.println(exportRaw);
      BATT_STATUS();
...
void IRDA3_PHASE_P14HP() {
  ...
  if (jsonMode) {
    ...
    nbytes = 71;
    PACKET_READ3();
    jsonSend_IRDA3P_PARSED_HPL((ndigits == 8) ? "IRDA3P14HP" : "IRDA3P13HP");
  } else {
    PACKET_READ_PARSEY();
    if (meter_flag == 4) {
      BATT_STATUS();
  ...
  if (len >= 30) {
    ...
    if (jsonMode) {
      ...
      if (meter_flag == 6) {
        ...
        nbytes = 79;
        PACKET_READ3();
        jsonSend_IRDA3P_PARSED("IRDA3SP");
        message2[6] = 0x00;
      }
    } else {
      PACKET_READ_PARSE();
    ...
    if (jsonMode) {
      ...
      nbytes = 71;
      PACKET_READ3();
      jsonSend_IRDA3P_PARSED_HPL("IRDA3P");
    } else {
      PACKET_READ_PARSEY();
      if (meter_flag == 4) {
        BATT_STATUS();
...
void PACKET_READ_PARSEY() {
  ...
  SerialBT.print(readString[30]);
  SerialBT.print(readString[29]);
  a = readString[28];
  bcd_char();
  SerialBT.print(a2);
  SerialBT.print(a1);
  ...
  str_hexto_dec();
  yx = y;
  SerialBT.print("VOLTAGE-R:");
  SerialBT.println(yx / 10);
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[40];
  message4[3] = readString[39];
  ...
  str_hexto_dec();
  yx = y;
  SerialBT.print("CURRENT-R:");
  SerialBT.println(yx / 100);
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[46];
  message4[3] = readString[45];
  ...
  SerialBT.println(a1);
  SerialBT.print("MAKE:");
  SerialBT.print(readString[64]);
  SerialBT.print(readString[65]);
  SerialBT.println(readString[66]);
  SerialBT.print("Phase:");
  SerialBT.println(readString[67], DEC);
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[69];
  message4[3] = readString[68];
...
void PACKET_READ_PARSE() {
  ...
  SerialBT.println(a1);
  SerialBT.print("MAKE:");
  SerialBT.print(readString[66]);
  SerialBT.print(readString[67]);
  SerialBT.println(readString[68]);
  SerialBT.print("Phase:");
  SerialBT.println(readString[69], DEC);
  message4[0] = 0;
  message4[1] = 0;
  message4[2] = readString[71];
  message4[3] = readString[70];
...
void IRIR1_PHASE() {
  readString = "";
  SerialPort1.println(":00413BC4");
  delay(200);
  PACKETIR_READ1();
  SerialPort1.println(":00423AC5");
  delay(200);
  PACKETIR_READ1();
  SerialPort1.println(":004339C6");
  delay(200);
  PACKETIR_READ1();
  SerialPort1.println(":004537C8");
  delay(600);
  PACKETIR_READ1();
  SerialPort1.println(":004636C9");
  delay(1000);
  PACKETIR_READ1();
  if (jsonMode) {
    jsonSend_IRIR1_RAW(readString);
  } else {
    SerialBT.println(readString);
    BATT_STATUS();
...
void IRIR1_PHASE_P() {
  ...
  l_rmd.remove(5);
  if (jsonMode) {
    jsonSend_IRIR1_PARSED(l_sno, l_mfid, l_kwh, l_rmd);
  } else {
    SerialBT.println("S.NO:" + l_sno);
    SerialBT.println("M.ID:" + l_mfid);
    SerialBT.println("KWH:" + l_kwh);
...
void IRIR3_PHASE() {
  readString = "";
  SerialPort1.write(message3[0]);
  delay(2);
  SerialPort1.write(message3[1]);
  delay(2);
  SerialPort1.write(message3[2]);
  delay(2);
  SerialPort1.write(message3[3]);
  delay(2);
  SerialPort1.write(message3[4]);
  delay(2);
  delay(500);
  readString = "";
  PACKETIR_READ3();
...
void readBluetoothName() {
  ...
  if (strlen(bluetooth_name) == 0) {
    strcpy(bluetooth_name, "PTA-DEFAULT");
    saveBluetoothName();
  }
}
